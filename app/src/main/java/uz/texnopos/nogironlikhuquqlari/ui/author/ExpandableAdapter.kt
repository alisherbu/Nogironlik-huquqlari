...
import uz.texnopos.mehrtilsimi.core.createDynamicViews
import uz.texnopos.mehrtilsimi.core.onClick
import uz.texnopos.mehrtilsimi.data.entities.Author
import uz.texnopos.mehrtilsimi.databinding.ItemExpandBinding


class ExpandableAdapter : RecyclerView.Adapter<ExpandableAdapter.ViewHolder>() {
    var last=0
    inner class ViewHolder(private val bind: ItemExpandBinding) : RecyclerView.ViewHolder(bind.root) {
